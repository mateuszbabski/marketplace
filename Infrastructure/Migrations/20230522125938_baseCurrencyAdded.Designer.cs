...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20230522125938_baseCurrencyAdded")]
    partial class baseCurrencyAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Invoices.ShopInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ShopInvoices", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Customers.Entities.ShoppingCarts.ShoppingCartItem", b =>
                {
                    ...
                    b.OwnsOne("Domain.Shared.ValueObjects.MoneyValue", "BaseCurrencyPrice", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Invoices.ShopInvoice", b =>
                {
                    b.HasOne("Domain.Invoices.Invoice", "Invoice")
                        .WithMany("ShopInvoices")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("Domain.Shared.ValueObjects.MoneyValue", "PartialOrderPrice", b1 =>
                        {
                            b1.Property<Guid>("ShopInvoiceId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ShopInvoiceId");

                            b1.ToTable("ShopInvoices");

                            b1.WithOwner()
                                .HasForeignKey("ShopInvoiceId");
                        });

                    b.Navigation("Invoice");

                    b.Navigation("PartialOrderPrice");
                });
